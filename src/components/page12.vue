<template>
  <div class="page12">
    ...
    <div class="center" v-else>
      ...
      <div>
        <img src="../assets/page12/topic.png"  class="topic">
      </div>
      <div>
        <div class="a" @click="choose(1)">
          <img src="../assets/page12/a.png">
        ...
        <img src="../assets/public/done10.png"  @click="done" class="done"> 
      </div>
      <div class="answer" v-if="real" @click="next">
        <img src="../assets/public/title.png"  class="title">
        <img src="../assets/page12/text.png"  class="text">
      </div>
    </div>
  </div>
</template>
